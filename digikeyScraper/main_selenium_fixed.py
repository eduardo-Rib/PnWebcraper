...
import time
import random
from scraper_selenium_fixed import DigiKeySeleniumScraper
import logging
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('scraper_selenium_fixed.log', encoding='utf-8'),
            logging.StreamHandler()
        ]
    )

def main():
    """Função principal para testar o scraper com Selenium corrigido"""
    setup_logging()
    logger = logging.getLogger(__name__)
    
    # Lista muito reduzida para teste inicial
    test_part_numbers = [
        "CL10C330JB8NNNC",
        "CL10B472KB8NNNC",
        "GRM1885C1H180JA01D",
    ...
    try:
        # Inicializa o scraper (modo NÃO headless para debug)
        logger.info("🔄 Inicializando WebDriver...")
        scraper = DigiKeySeleniumScraper(headless=False, delay=5.0)  # headless=False para ver o que acontece
